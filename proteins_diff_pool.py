...
if __name__ == "__main__":
    path = osp.join(osp.dirname(osp.realpath(__file__)), '..', 'data',
                    'mutag_dense')
    dataset = TUDataset(path, name='PTC_FM', transform=T.ToDense(max_nodes),
    ...
    test_data_loader = DenseDataLoader(test_dataset, batch_size=20)
    val_data_loader = DenseDataLoader(val_dataset, batch_size=20)
    train_data_loader = DenseDataLoader(train_dataset, batch_size=20)
